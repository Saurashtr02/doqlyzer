...
## Usage
There are two options that you need to specify when running DoQMeter: input and mode.
...
The two modes available when running DoQMeter indicate which type of features DoQMeter should extract.
...
this mode should be a directory containing two subdirectories: doq & ndoq. Each flow is saved in a file indicated by
